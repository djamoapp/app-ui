...
class AppColoredIcons {
  ...
  static String get bazarBox => "$kAssetPrefix/assets/icons/colored/Bazar Box.svg";
  ...
  static String get expenseLimit => "$kAssetPrefix/assets/icons/colored/Expense Limit.svg";

  static String get gift => "$kAssetPrefix/assets/icons/colored/Gift.svg";

  static String get giftGroup => "$kAssetPrefix/assets/icons/colored/Gift Group.svg";

  static String get guitar2 => "$kAssetPrefix/assets/icons/colored/Guitar2.svg";

  static String get personalBanl => "$kAssetPrefix/assets/icons/colored/Personal Bank.svg";
  ...
  static String get suitcases => "$kAssetPrefix/assets/icons/colored/Suitcases.svg";

  static String get transferIssue => "$kAssetPrefix/assets/icons/colored/Transfer Issue.svg";
